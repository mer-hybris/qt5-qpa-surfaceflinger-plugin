...
#ifndef EGLFSSURFACEFLINGERINTEGRATION_H
#define EGLFSSURFACEFLINGERINTEGRATION_H
...
namespace SurfaceFlingerInterface {
    class Compositor;
}

class EglFsSurfaceFlingerIntegration : public QEglFSDeviceIntegration
{
public:
    EglFsSurfaceFlingerIntegration();
    ~EglFsSurfaceFlingerIntegration();
...
private:
    ...
    struct SfClient *sf_client = nullptr;
    struct SfSurface *sf_surface = nullptr;
